...
// #cgo linux LDFLAGS: -lwhisper -lggml -lggml-cpu -lggml-base -lm -lstdc++ -lpthread
// #cgo windows LDFLAGS: -lwhisper -l:ggml.a -l:ggml-cpu.a -l:ggml-base.a -lm -lstdc++ -static-libgcc -static-libstdc++
// #cgo darwin LDFLAGS: -lwhisper -lggml -lggml-cpu -lggml-base -lm -lc++ -framework Accelerate
import "C"
